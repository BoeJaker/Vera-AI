...
# ============================================================================
# NETWORK MONITOR INPUT SCHEMAS
# ============================================================================

class NetworkMonitorInput(BaseModel):
    """Input schema for the continuous network monitor service."""
    targets: str = Field(
...
class NetworkScanInput(BaseModel):
    """Input schema for one-shot network range scanning."""
    target: str = Field(
        ...,
...
class HostScanInput(BaseModel):
    """Input schema for deep single-host port and banner scanning."""
