...
(function() {
    ...
    window.GraphAddon = {
        ...
        setupSettingsPanel: function() {
            ...
            // Add label customization section before existing sections
        ...
        waitForNetwork: function() {
            ...
            if (typeof network !== 'undefined' && network.body?.data?.nodes) {
                ...
                setTimeout(() => {
                    ...
                    setTimeout(() => this.populateLabelOptions(), 500);
                }, 100);
            } else {
        ...
        buildNodesData: function() {
            try {
                ...
                console.log('RAW NETWORK NODES:', nodes); 
    ...
    populateLabelOptions: function() {
        ...
        // Collect all unique properties from nodes
        ...
        // Collect all unique properties from edges
        const edges = network.body.data.edges.get();
        edges.forEach(edge => {
        ...
        console.log('Label options populated:', nodeProps.size, 'node properties,', edgeProps.size, 'edge properties');
    },
    ...
    updateNodeLabels: function() {
        ...
        try {
            ...
            network.body.data.nodes.update(nodeUpdates);
            console.log('Updated', nodeUpdates.length, 'node labels');
        } catch (e) {
            console.error('Error updating node labels:', e);
        }
    },
    ...
    updateEdgeLabels: function() {
        ...
        try {
            ...
            network.body.data.edges.update(edgeUpdates);
            console.log('Updated', edgeUpdates.length, 'edge labels');
        } catch (e) {
            console.error('Error updating edge labels:', e);
        }
    },
