...
from Vera.orchestration import task, proactive_task, TaskType, Priority
...
@proactive_task("proactive.ideas", estimated_duration=15.0)
...
@proactive_task("proactive.next_steps", estimated_duration=15.0)
...
@proactive_task("proactive.actions", priority=Priority.NORMAL, estimated_duration=20.0)
...
print("    - proactive.ideas (BACKGROUND/LOW, 15s)")
print("    - proactive.next_steps (BACKGROUND/LOW, 15s)")
